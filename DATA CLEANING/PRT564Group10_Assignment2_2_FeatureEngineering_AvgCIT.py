...
articletype_df['GAP_RETR_PUB'] = articletype_df['Retraction_Year'] - articletype_df['Public_Year'] 


# Calculate the CIT avg
articletype_df['CIT_AGV_RETRACT'] = articletype_df['CitationCount']/articletype_df['GAP_RETR_PUB']


# Get the current year
current_year = datetime.datetime.now().year
# Calculate the duration
articletype_df['GAP_PUB'] = current_year - articletype_df['Public_Year'] 
# Calculate the CIT avg
articletype_df['CIT_AGV_NONRETRACT'] = articletype_df['CitationCount']/articletype_df['GAP_RETR_PUB']
